...
public class BrickTagGame extends StateBasedGame implements Serializable {
	...
	public static final String MORE_BRICKS_RSC = "resource/extras.png";
	public static final String SCORE_UP_RSC = "resource/score_up.png";
	...
	public void initStatesList(GameContainer gameContainer) {
		...
		ResourceManager.loadImage(MORE_BRICKS_RSC);
		ResourceManager.loadImage(SCORE_UP_RSC);
